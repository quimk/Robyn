...
![result](https://user-images.githubusercontent.com/14415136/110111544-c81d1f80-7db0-11eb-9a9f-51249514baae.png)
  ...
  * The final function robyn_allocator() might throw error "provided ModID is not within the best result". First of all, please read all instructions behind the function. Model IDs are encoded in each onepager .png name and also in the title. Also, execute robyn_output$allSolutions will output all final model IDs. Please pick one and put it into robyn_allocator(). 
